...
<html>
<head>
  <title>Video Chart -- CLIENT</title>
      ...
      <div class="row">
          ...
          <div class="col-md-3">
               <div class="thumbnail frameHost">
                   <video id="client-video" class="video" muted="true" autoplay></video>
                   <div class="caption">
          ...
          <div class="col-md-3">
                  ...
                  <div id="step2">
                      ...
                      <div class="input-group">
                          ...
                          <a class="input-group-addon btn btn-success" id="make-call"><span class="glyphicon glyphicon-phone-alt"></span></a>
                      </div>
                  </div>
...
<% _.forEach(clientScripts, function(script) { %><script type="text/javascript" src="<%- script %>"></script><%- "\n" %><% }); %>
